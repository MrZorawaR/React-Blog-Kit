...
import { 
  ...
  ChevronDown, ChevronUp, Search, Share2, User
} from 'lucide-react'
    ...
    <form onSubmit={handleSubmit} className="max-w-5xl mx-auto pb-20 space-y-8">
      ...
      <div className="flex items-center justify-between sticky top-0   py-4 z-20 border-b border-gray-200 px-2">
        <div className="flex items-center gap-4">
          <Link to="/admin/blogs" className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isTagDropdownOpen && (
                    <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 shadow-xl rounded-xl z-50 max-h-48 overflow-y-auto p-1">
                      ...
                      <Link to="/admin/tags" className="block text-center p-2 text-xs text-blue-600 font-bold hover:underline border-t border-gray-100 mt-1">
                        + Manage Tags
                      </Link>
                    </div>
                  )}
...
{JSON.stringify({
  ...
  "author": {
    "@type": "Person",
    "name": defaultAuthor?.full_name || "Author Name"
  },
