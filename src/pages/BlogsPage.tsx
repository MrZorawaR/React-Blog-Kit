...
import { getBlogs, getFeaturedBlogs } from '@/lib/blog-service'
...
export default function BlogsPage() {
  ...
  const { data: featuredBlogs = [] } = useQuery({
    ...
    queryFn: () => getFeaturedBlogs(2)
  })

  // 2. Fetch All Articles with pagination
  const { data: blogsData } = useQuery({
    queryKey: ['blogs', 'list', page, search, tag],
    queryFn: () => getBlogs({ page, search, tag, isFeatured: false })
  })
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div>
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="#all-articles" className="text-sm font-bold text-gray-500 hover:text-blue-600 flex items-center gap-1 transition-colors">
